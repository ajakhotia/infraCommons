...
if(19 LESS CUDA_MIN_CLANG OR 19 GREATER CUDA_MAX_CLANG)
  message(FATAL_ERROR "Pinned clang++-19 is outside CUDA ${CUDA_MAJOR}'s supported clang++ range [${CUDA_MIN_CLANG}, ${CUDA_MAX_CLANG}]. Pick a different host toolchain or install a compatible CUDA major.")
endif()
